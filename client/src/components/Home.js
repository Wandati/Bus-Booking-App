  ...
  return (
    <div className="home-container">
      ...
      <div className="booking-form-container">
        <h2>Booking Form</h2>
        <div className="card shadow mb-5 bg-white rounded" style={{ width: '100%', height: '100vh' }}>
          <div className="card-body">
            ...
            <hr />
            <p className="searchText"><strong>Search For Affordable Buses</strong></p>
            <div className="row mb-3 mt-3">
              <label className="radiobtn">
                <input type="radio" name="gender" value="one-way" />One Way
              </label>
              <label className="radiobtn">
                <input type="radio" name="gender" value="round-trip" />Return Trip
              </label>
            </div>
            <div className="row">
              <div className="col-sm-6">
                <select className="browser-default custom-select mb-4" id="select-from">
              ...
              <div className="col-sm-6">
                <select className="browser-default custom-select mb-4" id="select-to">
            ...
            <div className="row">
              ...
              <input type="datetime-local" id="depaturetime" name="depaturetime"/>
              </div>
            </div>
          </div>
        </div>
...
export default Home;
>>>>>>> fae99c099c5fae8adc107f3c155559dcf906c496
