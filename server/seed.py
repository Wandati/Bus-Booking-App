...
with app.app_context():
    ...
    buses_data = [
        ...
        {"number_plate": "KCB780B",  "route_id": 1, "owner_id": 2, "capacity": 70, "driver": "Driver B","departure_time":"2023-10-05 21:00:00"},
        {"number_plate": "KCC781C",  "route_id": 2, "owner_id": 2, "capacity": 40, "driver": "Driver C","departure_time":"2023-10-07 08:00:00"},
        {"number_plate": "KCD784D",  "route_id": 2, "owner_id": 2, "capacity": 60, "driver": "Driver D","departure_time":"2023-10-07 18:00:00"},
        {"number_plate": "KCE785E",  "route_id": 3, "owner_id": 2, "capacity": 30, "driver": "Driver E","departure_time":"2023-10-23 05:00:00"},
        {"number_plate": "KCF782F",  "route_id": 3, "owner_id": 3, "capacity": 45, "driver": "Driver F","departure_time":"2023-10-23 22:00:00"},
        {"number_plate": "KCG783G",  "route_id": 4, "owner_id": 3, "capacity": 60, "driver": "Driver G","departure_time":"2023-10-28 07:00:00"},
        {"number_plate": "KCH759H",  "route_id": 4, "owner_id": 3, "capacity": 70, "driver": "Driver H","departure_time":"2023-10-28 20:00:00"},
        {"number_plate": "KCI729I",  "route_id": 5, "owner_id": 3, "capacity": 50, "driver": "Driver I","departure_time":"2023-10-30 06:00:00"},
        {"number_plate": "KCJ509J",  "route_id": 5, "owner_id": 3, "capacity": 30, "driver": "Driver J","departure_time":"2023-10-30 23:00:00"},
        {"number_plate": "KCK229K",  "route_id": 6, "owner_id": 4, "capacity": 50, "driver": "Driver K","departure_time":"2023-11-21 06:30:00"},
        {"number_plate": "KDL349L",  "route_id": 6, "owner_id": 4, "capacity": 45, "driver": "Driver L","departure_time":"2023-11-21 00:00:00"},
        {"number_plate": "KDM369M",  "route_id": 7, "owner_id": 4, "capacity": 60, "driver": "Driver M","departure_time":"2023-11-15 05:30:00"},
        ...
        {"number_plate": "KDE600P",  "route_id": 8, "owner_id": 5, "capacity": 70, "driver": "Driver P","departure_time":"2023-11-01 17:00:00"},
        {"number_plate": "KDC724Q",  "route_id": 9, "owner_id": 5, "capacity": 60, "driver": "Driver Q","departure_time":"2023-11-20 06:00:00"},
        {"number_plate": "KDF229R",  "route_id": 9, "owner_id": 5, "capacity": 65, "driver": "Driver R","departure_time":"2023-11-20 21:00:00"},
        {"number_plate": "KDJ298T",  "route_id": 10, "owner_id": 5, "capacity": 50, "driver":"Driver S","departure_time":"2023-11-14 07:00:00"},
        {"number_plate": "KDN198T",  "route_id": 10, "owner_id": 5, "capacity": 55, "driver":"Driver T","departure_time":"2023-11-14 20:30:00"}
    ]
